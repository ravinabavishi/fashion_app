...
class _MyntraMallState extends State<MyntraMall> {
  ...
  final List<Travel1> TravelList12 = [
    ...
    Travel1("LEVIS", "assets/images/cm10.jpg", ),
    Travel1("POLO", "assets/images/cm3.jpg", ),
    Travel1("ONLY", "assets/images/cm4.jpg", ),
    Travel1("WROGN", "assets/images/cm5.jpg", ),
    Travel1("FOREVER", "assets/images/cm6.jpg", ),
    Travel1("VERO MODA", "assets/images/cm7.jpg", ),
    Travel1("JACK&JONES", "assets/images/cm8.jpg", ),
                            ...
                            children: [
                             ...
                             /* SizedBox(height: 10,),*/
                              Padding(
                                ...
                                child: Text(TravelList12[index].name,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 18),),
                              )
                            ],
                          ),
                        );
